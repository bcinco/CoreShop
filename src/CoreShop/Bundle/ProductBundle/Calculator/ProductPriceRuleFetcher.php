...
class ProductPriceRuleFetcher implements ProductPriceRuleFetcherInterface
{
    /**
     ...
     */
    public function __construct(ProductPriceRuleRepositoryInterface $productPriceRuleRepository)
    {
    ...
    public function getPriceRules(ProductInterface $subject): array
    {
        ...
        return $this->productPriceRuleRepository->findActive();
    }
}