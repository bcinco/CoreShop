...
interface OrderDocumentItemTransformerInterface
{
     ...
     * @return mixed
     */
    public function transform(OrderDocumentInterface $orderDocument, OrderItemInterface $orderItem, OrderDocumentItemInterface $documentItem, $quantity): OrderDocumentItemInterface;
}
